...
export const Route = createFileRoute("/disclaimer")({
  head: () => ({
    meta: [
      { title: "Disclaimer — Tier2X" },
      { name: "description", content: "Important information about the limitations and scope of content on Tier2X." },
      { property: "og:title", content: "Disclaimer — Tier2X" },
      ...
      <article className="mx-auto max-w-3xl px-4 pb-20 pt-10 md:px-8">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section>
            ...
            <p className="mt-3">
              The information provided on Tier2X is for general informational
          ...
          <section>
            ...
            <p className="mt-3">
              Content on Tier2X does not constitute legal, financial, career, or
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              Tier2X does not endorse or verify them. Any reliance you place on
