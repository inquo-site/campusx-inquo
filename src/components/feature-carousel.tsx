...
const CARDS: Card[] = [
  ...
  { key: "mentor", label: "AI Mentor", icon: MessageSquareCode, headline: "Chat with Tier2X", detailKicker: "Gemini", detail: "Ask about stack, resume, interviews", hue: "linear-gradient(160deg,#f5efe1 0%,#e8dcc0 100%)", accent: "#d4b062", Illustration: IllMentor },
